...
public class SettingsExtensionsTests
{
    ...
    public void Should_convert_all_extensions_to_arguments(Action<AsciiDoctorJRunnerSettings> setFlag,
    ...
    public void Should_return_the_settings_for_fluent_re_use(
        Func<AsciiDoctorJRunnerSettings, AsciiDoctorJRunnerSettings> fluentMethod)
    {
        var sut = new AsciiDoctorJRunnerSettings();

...
BuildParameters.SetParameters(
    ...
    shouldRunDupFinder: false, // dupFinder is discontinued since 2021.3
...
ToolSettings.SetToolPreprocessorDirectives(
    reSharperTools: "#tool nuget:?package=JetBrains.ReSharper.CommandLineTools&version=2021.3.2");
